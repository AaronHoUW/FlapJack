            ...
            <main>
                <div className="about-us">
                    <div className="info-section ">
                        ...
                        <span className="marine-rescue col-xs-5 col-md-6 m-4">
                ...
                <div className="about-team">
                        ...
                        <span className="four-members col-xs-12 col-md-12 mt-5">
                ...
                <div className="ack-section">
                    ...
                    <span className="shout-out col-xs-12 col-md-12 mt-5">
                        ...
                        <span className="col-xs-12 col-md-12 mt-5">
