                   ...
                   <div className='row what-content-height'>
                        <div className='col my-auto'>
                         <h2 className='third-title'>Level 3: Meet Wendy the Whale</h2>
                            <p className='third-info'> Meet Shawn and learn about the whale and the plastic that they eat. Maybe you can even help get rid of plastic inside the whale’s body!
                           </p>
                           <a href="/level3">
                                <button className="link-button">Play</button>
                                </a>
                       ...
                       <div className='col'>
                         <img className='wen-level' src='./imgs/final-wendy.png' alt="Wendy the Whale"></img>
                     </div>
                    </div>
             </div>
</div>
