                ...
                <div className="container">
                    <section className="row">
                        ...
                        <div className="col-xs-4 col-md-6 mt-5">
                            ...
                            <div className='modal-video-content m-0'>
									<iframe width="100%" height="100%" src={"https://www.youtube.com/embed/xFPoIU5iiYQ"} />
                            </div>
                        ...
                        <div className="col-xs-4 col-md-6 mt-5">
                            ...
                            <div className='modal-video-content m-0'>
									<iframe width="100%" height="100%" src={"https://www.youtube.com/embed/hC_isxflaVA"} />
                            </div>
                        </div>
                        {/* <div className="col-xs-4 col-md-6 mt-8">
                            <img className="sleep-image mt-5" src='./imgs/dodo.png' alt=' whale net video'></img>
                        </div> */}
                        <div className="col-xs-4 col-md-6 mt-5 pb-5">
                            ...
                            <div className='modal-video-content m-0'>
									<iframe width="100%" height="100%" src={"https://www.youtube.com/embed/xCKPsVi3vBo"} />
                            </div>
                        </div>
                        {/* <div className="col-xs-4 col-md-6 mt-8">
